...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.grpc.GreetingServiceOuterClass.HelloRequest,
      org.example.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = org.example.grpc.GreetingServiceOuterClass.HelloRequest.class,
      responseType = org.example.grpc.GreetingServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.grpc.GreetingServiceOuterClass.HelloRequest,
      org.example.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<org.example.grpc.GreetingServiceOuterClass.HelloRequest, org.example.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<org.example.grpc.GreetingServiceOuterClass.HelloRequest, org.example.grpc.GreetingServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.GreetingServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.GreetingServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(org.example.grpc.GreetingServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<org.example.grpc.GreetingServiceOuterClass.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.example.grpc.GreetingServiceOuterClass.HelloRequest,
                org.example.grpc.GreetingServiceOuterClass.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public org.example.grpc.GreetingServiceOuterClass.HelloResponse greeting(org.example.grpc.GreetingServiceOuterClass.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.grpc.GreetingServiceOuterClass.HelloResponse> greeting(
        org.example.grpc.GreetingServiceOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((org.example.grpc.GreetingServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<org.example.grpc.GreetingServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.grpc.GreetingServiceOuterClass.getDescriptor();
    }
